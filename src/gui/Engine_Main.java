...
//		glFrontFace(GL_CCW); 
	...
	public static class PATHS {
		...
		public static final String RESOURCE_PATH = (new File("")).getAbsolutePath() + OS_Specifics.getFilepathSeperator() + "res"+ OS_Specifics.getFilepathSeperator();
		public static final String SHADER_PATH = RESOURCE_PATH + "Shader"+ OS_Specifics.getFilepathSeperator();
		public static final String TEXTURE_PATH = RESOURCE_PATH + "Textures"+ OS_Specifics.getFilepathSeperator();
		public static final String MODEL_PATH = RESOURCE_PATH + "Models"+ OS_Specifics.getFilepathSeperator();
	}
