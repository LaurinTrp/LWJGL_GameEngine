...
import static org.lwjgl.system.JNI.invokePPF;
...
import static org.lwjgl.system.JNI.invokePPPPPPPPI;
...
//    }
     ...
     * <p>Property type: bool. The default value is false (0)</p>
     */
    public static final String AI_CONFIG_FBX_USE_SKELETON_BONE_CONTAINER = "AI_CONFIG_FBX_USE_SKELETON_BONE_CONTAINER";
     ...
     * 
     * <p>If this property is set to true, the unit size provided in the file header will be ignored and the file will be loaded without scaling the assets.</p>
     * 
     * <p>Property type: Bool. Default value: false.</p>
     */
    public static final String AI_CONFIG_IMPORT_COLLADA_IGNORE_UNIT_SIZE = "IMPORT_COLLADA_IGNORE_UNIT_SIZE";
     ...
     * <p>Property type: Bool. Default value: false.</p>
     */
    public static final String AI_CONFIG_USE_GLTF_PBR_SPECULAR_GLOSSINESS = "USE_GLTF_PBR_SPECULAR_GLOSSINESS";

    /**
     * Specifies whether to apply a limit on the number of four bones per vertex in skinning
     * 
     * <p>When this flag is not defined, all bone weights and indices are limited to a maximum of four bones for each vertex (attributes {@code JOINT_0} and
     ...
     * <p>Property type: Bool. Default value: false.</p>
     */
    public static final String AI_CONFIG_EXPORT_GLTF_UNLIMITED_SKINNING_BONES_PER_VERTEX = "USE_UNLIMITED_BONES_PER VERTEX";
     ...
     * ply) had to split vertices. Then you need one regardless.</p>
     * </li>
     ...
     */
    @NativeType("aiReturn")
    public static int aiExportSceneEx(@NativeType("struct aiScene const *") AIScene pScene, @NativeType("char const *") ByteBuffer pFormatId, @NativeType("char const *") ByteBuffer pFileName,  @NativeType("struct aiFileIO const *") AIFileIO pIO, @NativeType("unsigned int") int pPreProcessing) {
        if (CHECKS) {
            checkNT1(pFormatId);
            checkNT1(pFileName);
        }
     ...
     */
    @NativeType("aiReturn")
    public static int aiExportSceneEx(@NativeType("struct aiScene const *") AIScene pScene, @NativeType("char const *") CharSequence pFormatId, @NativeType("char const *") CharSequence pFileName,  @NativeType("struct aiFileIO const *") AIFileIO pIO, @NativeType("unsigned int") int pPreProcessing) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(pFormatId, true);
            long pFormatIdEncoded = stack.getPointerAddress();
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileEx(@NativeType("char const *") ByteBuffer pFile, @NativeType("unsigned int") int pFlags,  @NativeType("struct aiFileIO *") AIFileIO pFS) {
        if (CHECKS) {
            checkNT1(pFile);
        }
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileEx(@NativeType("char const *") CharSequence pFile, @NativeType("unsigned int") int pFlags,  @NativeType("struct aiFileIO *") AIFileIO pFS) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(pFile, true);
            long pFileEncoded = stack.getPointerAddress();
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileExWithProperties(@NativeType("char const *") ByteBuffer pFile, @NativeType("unsigned int") int pFlags,  @NativeType("struct aiFileIO *") AIFileIO pFS, @NativeType("struct aiPropertyStore const *") AIPropertyStore pProps) {
        if (CHECKS) {
            checkNT1(pFile);
        }
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileExWithProperties(@NativeType("char const *") CharSequence pFile, @NativeType("unsigned int") int pFlags,  @NativeType("struct aiFileIO *") AIFileIO pFS, @NativeType("struct aiPropertyStore const *") AIPropertyStore pProps) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(pFile, true);
            long pFileEncoded = stack.getPointerAddress();
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileFromMemory(@NativeType("char const *") ByteBuffer pBuffer, @NativeType("unsigned int") int pFlags,  @NativeType("char const *") ByteBuffer pHint) {
        if (CHECKS) {
            checkNT1Safe(pHint);
        }
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileFromMemory(@NativeType("char const *") ByteBuffer pBuffer, @NativeType("unsigned int") int pFlags,  @NativeType("char const *") CharSequence pHint) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileFromMemoryWithProperties(@NativeType("char const *") ByteBuffer pBuffer, @NativeType("unsigned int") int pFlags,  @NativeType("char const *") ByteBuffer pHint, @NativeType("struct aiPropertyStore const *") AIPropertyStore pProps) {
        if (CHECKS) {
            checkNT1Safe(pHint);
        }
    ...
    @NativeType("struct aiScene *")
    public static AIScene aiImportFileFromMemoryWithProperties(@NativeType("char const *") ByteBuffer pBuffer, @NativeType("unsigned int") int pFlags,  @NativeType("char const *") CharSequence pHint, @NativeType("struct aiPropertyStore const *") AIPropertyStore pProps) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
            stack.nUTF8Safe(pHint, true);
            long pHintEncoded = pHint == null ? NULL : stack.getPointerAddress();
    ...
    public static AILogStream aiGetPredefinedLogStream(@NativeType("aiDefaultLogStream") int pStreams,  @NativeType("char const *") ByteBuffer file, @NativeType("struct aiLogStream") AILogStream __result) {
        if (CHECKS) {
            checkNT1Safe(file);
        }
     ...
     */
    @NativeType("struct aiLogStream")
    public static AILogStream aiGetPredefinedLogStream(@NativeType("aiDefaultLogStream") int pStreams,  @NativeType("char const *") CharSequence file, @NativeType("struct aiLogStream") AILogStream __result) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
     ...
     */
    public static void aiReleaseImport( @NativeType("struct aiScene const *") AIScene pScene) {
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") FloatBuffer pOut,  @NativeType("unsigned int *") IntBuffer pMax) {
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") FloatBuffer pOut,  @NativeType("unsigned int *") IntBuffer pMax) {
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax.get(pMax.position())); }
        }
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialIntegerArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("int *") IntBuffer pOut,  @NativeType("unsigned int *") IntBuffer pMax) {
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax.get(pMax.position())); }
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialIntegerArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("int *") IntBuffer pOut,  @NativeType("unsigned int *") IntBuffer pMax) {
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax.get(pMax.position())); }
        }
     ...
     */
    @NativeType("aiReturn")
    public static int aiGetMaterialTexture(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("aiTextureType") int type, @NativeType("unsigned int") int index, @NativeType("struct aiString *") AIString path,  @NativeType("aiTextureMapping *") IntBuffer mapping,  @NativeType("unsigned int *") IntBuffer uvindex,  @NativeType("float *") FloatBuffer blend,  @NativeType("aiTextureOp *") IntBuffer op,  @NativeType("aiTextureMapMode *") IntBuffer mapmode,  @NativeType("unsigned int *") IntBuffer flags) {
        if (CHECKS) {
            checkSafe(mapping, 1);
            checkSafe(uvindex, 1);
            checkSafe(blend, 1);
    ...
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") float[] pOut,  @NativeType("unsigned int *") int[] pMax) {
        long __functionAddress = Functions.GetMaterialFloatArray;
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
    ...
    /** Array version of: {@link #aiGetMaterialFloatArray GetMaterialFloatArray} */
    @NativeType("aiReturn")
    public static int aiGetMaterialFloatArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("float *") float[] pOut,  @NativeType("unsigned int *") int[] pMax) {
        long __functionAddress = Functions.GetMaterialFloatArray;
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax[0]); }
    ...
    @NativeType("aiReturn")
    public static int aiGetMaterialIntegerArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") ByteBuffer pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("int *") int[] pOut,  @NativeType("unsigned int *") int[] pMax) {
        long __functionAddress = Functions.GetMaterialIntegerArray;
        if (CHECKS) {
            checkNT1(pKey);
            checkSafe(pMax, 1);
    ...
    /** Array version of: {@link #aiGetMaterialIntegerArray GetMaterialIntegerArray} */
    @NativeType("aiReturn")
    public static int aiGetMaterialIntegerArray(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("char const *") CharSequence pKey, @NativeType("unsigned int") int type, @NativeType("unsigned int") int index, @NativeType("int *") int[] pOut,  @NativeType("unsigned int *") int[] pMax) {
        long __functionAddress = Functions.GetMaterialIntegerArray;
        if (CHECKS) {
            checkSafe(pMax, 1);
            if (pMax != null) { check(pOut, pMax[0]); }
    ...
    @NativeType("aiReturn")
    public static int aiGetMaterialTexture(@NativeType("struct aiMaterial const *") AIMaterial pMat, @NativeType("aiTextureType") int type, @NativeType("unsigned int") int index, @NativeType("struct aiString *") AIString path,  @NativeType("aiTextureMapping *") int[] mapping,  @NativeType("unsigned int *") int[] uvindex,  @NativeType("float *") float[] blend,  @NativeType("aiTextureOp *") int[] op,  @NativeType("aiTextureMapMode *") int[] mapmode,  @NativeType("unsigned int *") int[] flags) {
        long __functionAddress = Functions.GetMaterialTexture;
        if (CHECKS) {
            checkSafe(mapping, 1);
            checkSafe(uvindex, 1);
