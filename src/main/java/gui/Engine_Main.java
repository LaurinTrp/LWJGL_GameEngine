...
//		public static final String RESOURCE_PATH = new File("resources").getAbsolutePath() + OS_Specifics.getFilepathSeperator();
		public static final String SHADER_PATH = Engine_Main.class.getClassLoader().getResource("Shader").getFile() + OS_Specifics.getFilepathSeperator();
		public static final String TEXTURE_PATH = Engine_Main.class.getClassLoader().getResource("Textures").getFile() + OS_Specifics.getFilepathSeperator();
		public static final String MODEL_PATH = Engine_Main.class.getClassLoader().getResource("Models").getFile() + OS_Specifics.getFilepathSeperator();
	}
